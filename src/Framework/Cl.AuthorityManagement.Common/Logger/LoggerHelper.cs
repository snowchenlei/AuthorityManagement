...
namespace Cl.AuthorityManagement.Common.Logger
{
    public class LoggerHelper
    {
        private static readonly ILog LogApiError = LogManager.GetLogger("LogApiError");
        private static readonly ILog LogMvcError = LogManager.GetLogger("LogMvcError");

        private static readonly ILog LogRequestMonitor = LogManager.GetLogger("LogRequestMonitor");
        private static readonly ILog LogApiMonitor = LogManager.GetLogger("LogApiMonitor");
        private static readonly ILog LogMvcMonitor = LogManager.GetLogger("LogMvcMonitor");

        private static readonly ILog LogOperate = LogManager.GetLogger("LogOperate");
